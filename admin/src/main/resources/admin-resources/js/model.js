        ...
        <div v-for="(field, index) in selectedmodel.fields" v-if="field.type != 'OBJECT' "
            ...
            <div class="uk-form-controls">
                ...
                <vuejs-datepicker v-if="field.type == 'DATE'" v-model="selecteddata[field.name]"
                                  ...
                                  output-format = "x" :minimumDate="field.minimumDate" no-header="true" :maximumDate="field.maximumDate" :auto-close = "!field.includeTime" :only-date="!field.includeTime">
                ...
                <div class="uk-accordion-content">
                    <div v-for="(field, index) in fieldOuter.fields"
                        ...
                        <vuejs-datepicker v-if="field.type == 'DATE'"
                                          ...
                                          format="x"
                                          calendar-class="uk-dark"
                                          output-format = "x" :minimumDate="field.minimumDate" no-header="true" :maximumDate="field.maximumDate" :auto-close = "!field.includeTime" :only-date="!field.includeTime"></vuejs-datepicker>
